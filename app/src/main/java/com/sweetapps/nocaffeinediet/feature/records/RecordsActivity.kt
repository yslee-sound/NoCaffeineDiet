package com.sweetapps.nocaffeinediet.feature.records
...
import com.sweetapps.nocaffeinediet.feature.records.components.RecordsScreen
...
class RecordsActivity : BaseActivity() {
    ...
    override fun getScreenTitle(): String = "노카페인 기록"
